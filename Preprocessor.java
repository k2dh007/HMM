...
public class Preprocessor {
	...
	public static class PathProb{
		public String path;
		public int lastTag;
		public double probability;
		
		public PathProb(String path, int lastTag, double probability) {
			this.path = path;
    ...
    public static void main(String[] args){
    	...
    	try{
        	...
        	HashMap<Character, Syllable2> b = new HashMap<Character, Syllable2>();
        	HashMap<Character, Syllable2> b2 = new HashMap<Character, Syllable2>();
